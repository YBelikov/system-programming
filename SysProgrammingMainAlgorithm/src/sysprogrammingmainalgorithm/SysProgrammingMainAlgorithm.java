...
public class SysProgrammingMainAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        //TestPascalParser pl0Parser = null;
        StudentClass myLangMine=null;
        int codeAction, llk=1, textLen;
        String [] menu= { "*1.  Прочитати граматику з файла  ",
                " 2.  Лабораторна робота. Клас будує студент(5.\tПеревірити, чи є побудована множина LL(1)- граматикою)",
            ...
            switch (codeAction) {
                case 1: //1. Прочитати граматику з файла",
                    ...
                    try {
                        ...
                        myLangMine=new StudentClass(fileName,llk);
                    }
                    catch(Exception ee)
                    { System.out.println ("Системна помилка: "+ee.toString());
                        return;
                    }
                    testLang = new StudentClass(fileName,llk);
                ...
                case 7:  //Побудова списку епсілон-нетерміналів
                     int [] kepsilon=testLang.createEpsilonNonterminals();
                    testLang.setEpsilonNonterminals (kepsilon);
                    result=true;
                    break;
                ...
                case 13:  //Побудувати множини FirstK
                    LlkContext [] ffirstContext = testLang.firstK();
                    testLang.setFirstK(ffirstContext);
                    result=true;
                    break;
